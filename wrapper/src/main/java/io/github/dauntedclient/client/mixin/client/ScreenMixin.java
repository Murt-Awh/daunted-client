...
public abstract class ScreenMixin implements ScreenExtension {
	...
	public void postGuiRender(int mouseX, int mouseY, float partialTicks, CallbackInfo callback) {
		...
		if (DauntedClientConfig.instance.logoInInventory && (Object) this instanceof HandledScreen) {
			GlStateManager.enableBlend();

			client.getTextureManager().bindTexture(
					new Identifier("daunted_client", "textures/gui/daunted_client_logo_with_text_" + MinecraftUtils.getTextureScale() + ".png"));
