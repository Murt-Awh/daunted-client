...
import io.github.dauntedclient.client.mod.option.impl.ColourOption;
...
public class ColourPickerDialog extends BlockComponent {
	...
	public ColourPickerDialog(ColourOption option, Colour colour, Consumer<Colour> callback) {
		...
		if (option.canApplyToAll()) {
			add(new ButtonComponent("daunted_client.mod.screen.apply_to_all", theme.button(), theme.fg())
	...
	public void render(ComponentRenderInfo info) {
		...
		NanoVG.nvgFillPaint(nvg,
				MinecraftUtils.nvgMinecraftTexturePaint(nvg, new Identifier("daunted_client", "textures/gui/hues.png"),
		...
		NanoVG.nvgFillColor(nvg, theme.fg.nvg());
		regularFont.renderString(nvg, I18n.translate("daunted_client.hex"), PICKER_X + PICKER_WIDTH + 12, PICKER_Y + 31.5F);
		regularFont.renderString(nvg, I18n.translate("daunted_client.rgb"), PICKER_X + PICKER_WIDTH + 12, PICKER_Y + 50.5F);
		regularFont.renderString(nvg, I18n.translate("daunted_client.alpha"), PICKER_X + PICKER_WIDTH + 12,
				PICKER_Y + 69.5F);
		...
		String previousText = I18n.translate("daunted_client.previous_colours");
