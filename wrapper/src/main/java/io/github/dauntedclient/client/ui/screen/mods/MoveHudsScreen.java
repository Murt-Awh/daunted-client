...
import io.github.dauntedclient.client.ui.component.impl.ButtonComponent;
...
public class MoveHudsScreen extends PanoramaBackgroundScreen {
	...
	protected void keyPressed(char character, int code) {
		if (code == 1 || (code == DauntedClientConfig.instance.editHudKey.getCode()
				&& KeyBindingExtension.from(DauntedClientConfig.instance.editHudKey).areModsPressed())) {
