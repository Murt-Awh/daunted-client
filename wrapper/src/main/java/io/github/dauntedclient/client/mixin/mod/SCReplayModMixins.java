...
import io.github.dauntedclient.client.event.impl.ReceiveChatMessageEvent;
import io.github.dauntedclient.client.mod.impl.replay.*;
import io.github.dauntedclient.client.mod.impl.replay.fix.SCSettingsRegistry;
import io.github.dauntedclient.client.ui.screen.JGuiPreviousScreen;
...
public class SCReplayModMixins {
	...
	public static class GuiSavingReplayMixin {
		...
		@Redirect(method = "presentRenameDialog", at = @At(value = "INVOKE", target = "Lio/github/dauntedclient/client/mod/impl/replay/fix"
				+ "/SCSettingsRegistry;get(Lio/github/dauntedclient/client/mod/impl/replay/fix/SCSettingsRegistry$SettingKey;)"
