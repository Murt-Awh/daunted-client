...
import io.github.dauntedclient.client.extension.MinecraftClientExtension;
import io.github.dauntedclient.client.mod.impl.TweaksMod;
...
public class TweaksModMixins {
	...
	public static class GameMenuScreenMixin {
		...
		public void overrideButton(ButtonWidget button, CallbackInfo callback) {
			if (button.id == 1 && !disconnect) {
				callback.cancel();
				button.message = Formatting.GREEN + I18n.translate("daunted_client.mod.tweaks.confirm_disconnect");
				disconnect = true;
			}
		}
	...
	public static class DisconnectedScreenMixin extends Screen {
		...
		public void postInit(CallbackInfo callback) {
			...
			int y = last.y;
			last.y += 24;
			buttons.add(new ButtonWidget(100, last.x, y, I18n.translate("daunted_client.mod.tweaks.reconnect")));
		}
