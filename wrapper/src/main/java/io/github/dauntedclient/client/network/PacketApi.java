...
import io.github.dauntedclient.client.event.impl.ServerConnectEvent;
import io.github.dauntedclient.client.network.action.ApiAction;
...
public final class PacketApi {
	...
	private static final String CHANNEL = "daunted-client:v1";
	...
	public void receive(CustomPayloadS2CPacket payload) {
		...
		try {
			...
			LOGGER.warn("A Daunted Client API usage error has occured. This is most likely an issue with the server.",
					error);
