...
import io.github.dauntedclient.client.extension.ScreenExtension;
import io.github.dauntedclient.client.mod.impl.hud.chat.*;
		...
		public void replaceGui(CallbackInfo callback) {
			if (ChatMod.enabled) {
				...
				buttons.add(new ButtonWidget(201, width / 2 - (150 / 2), height / 6 + 98, 150, 20,
						I18n.translate("daunted_client.more_options")));
