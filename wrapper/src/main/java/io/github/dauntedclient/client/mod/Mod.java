...
import io.github.dauntedclient.client.mod.option.impl.*;
...
@AbstractTranslationKey("daunted_client.mod.generic")
public abstract class Mod extends Object {
	...
	protected List<ModOption<?>> createOptions() {
		...
		if (!(this instanceof ConfigOnlyMod)) {
			options.add(new ToggleOption("daunted_client.mod.generic.enabled",
