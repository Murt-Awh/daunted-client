...
package io.github.dauntedclient.client.mod.impl.discord.socket;
...
public class User {
	...
	public void bindTexture() {
		...
		if (avatar == null) {
			textures.bindTexture(new Identifier("daunted_client", "textures/gui/discord_avatar_generic.png"));
			return;
		}
