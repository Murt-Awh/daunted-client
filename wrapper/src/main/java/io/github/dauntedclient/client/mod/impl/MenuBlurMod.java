...
public class MenuBlurMod extends DauntedClientMod implements PrimaryIntegerSettingMod {
	...
	@Expose
	@Option
	@Slider(min = 0, max = 1, step = 0.1F, format = "daunted_client.slider.seconds")
	...
	public String getDetail() {
		return I18n.translate("daunted_client.mod.screen.originally_by", "tterrag1098");
	}
