...
public class ZoomMod extends DauntedClientMod implements PrimaryIntegerSettingMod {
	...
	@Expose
	@Option
	@Slider(min = 1, max = 100, step = 1, format = "daunted_client.slider.percent")
	private float animationSpeed = 75;
	@Expose
	@Option
	@Slider(min = 2, max = 32, step = 1, format = "daunted_client.slider.factor")
	...
	public String getDetail() {
		return I18n.translate("daunted_client.mod.screen.inspired_by", "EnnuiL");
	}
