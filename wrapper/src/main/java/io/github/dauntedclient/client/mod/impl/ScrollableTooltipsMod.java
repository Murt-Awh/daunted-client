...
public class ScrollableTooltipsMod extends DauntedClientMod {
	...
	public String getDetail() {
		return I18n.translate("daunted_client.mod.screen.by", "moehreag"); // maybe also add original creator
	}
