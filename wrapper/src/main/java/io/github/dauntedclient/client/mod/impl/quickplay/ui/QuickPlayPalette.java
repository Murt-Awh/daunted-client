...
import io.github.dauntedclient.client.mod.impl.quickplay.database.QuickPlayGame;
...
public class QuickPlayPalette extends ComponentScreen {
	...
	public static class QuickPlayPaletteComponent extends BlockComponent {
		...
		public QuickPlayPaletteComponent(QuickPlayMod mod) {
			...
			search = new TextFieldComponent(250, false).withPlaceholder("daunted_client.mod.screen.search").autoFlush()
					.onUpdate((ignored) -> {
						scroll.load();
						return true;
