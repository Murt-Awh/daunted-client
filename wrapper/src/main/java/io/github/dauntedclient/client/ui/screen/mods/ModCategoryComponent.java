...
import io.github.dauntedclient.client.ui.screen.mods.ModsScreen.ModsScreenComponent;
	...
	private final class Header extends ColouredComponent {
		...
		public void render(ComponentRenderInfo info) {
			...
			NVGPaint paint = MinecraftUtils.nvgMinecraftTexturePaint(nvg,
					new Identifier("daunted_client", "textures/gui/collapsed.png"), 0, arrowOffset, 8, 8, 0);
