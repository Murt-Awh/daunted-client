...
public class ReplayModMixinPluginCompat {
	...
	public byte[] transform(String name, byte[] input) {
		...
		hasClass.visitMethodInsn(Opcodes.INVOKESTATIC, "io/github/dauntedclient/wrapper/ClassWrapper", "getInstance", "()Lio/github/dauntedclient/wrapper/ClassWrapper;", false);
		hasClass.visitVarInsn(Opcodes.ALOAD, 0);
		hasClass.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "io/github/dauntedclient/wrapper/ClassWrapper", "isAvailable", "(Ljava/lang/String;)Z", false);
