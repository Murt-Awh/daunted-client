...
import io.github.dauntedclient.wrapper.transformer.ClassTransformer;
...
public final class ClassWrapper extends URLClassLoader {
	...
	private static final String[] EXCLUDED_PACKAGES = {
			...
			"org.spongepowered",
			// important
			"io.github.dauntedclient.wrapper",
			"io.github.dauntedclient.utils"
	};
	...
	private boolean shouldHideResource(String name) {
		return GlobalConstants.DEV && name.equals("daunted-client-wrapper-refmap.json");
	}
