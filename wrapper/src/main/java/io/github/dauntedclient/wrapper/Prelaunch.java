...
public final class Prelaunch {
	...
	public static URL[] prepareClasspath() throws IOException {
		...
		Path cache = Paths.get(".daunted-client-wrapper");
		if (!Files.isDirectory(cache))
			Files.createDirectories(cache);

		String jar = System.getProperty("io.github.dauntedclient.wrapper.jar");
		if (jar != null) {
			...
			throw new UnsupportedOperationException("-Dio.github.dauntedclient.wrapper.jar is required");
