...
class Utils {
	...
	static init() {
		...
		switch(Utils.getOsName()) {
			case "linux":
				Utils.dataDirectory += "/.config/Daunted Client";
				break;
			case "osx":
				Utils.dataDirectory += "/Library/Application Support/Daunted Client";
				break;
			case "windows":
				Utils.dataDirectory += "/AppData/Roaming/Daunted Client";
				break;
		}
