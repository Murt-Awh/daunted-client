...
class Launcher {
	...
	async launch(callback, progress, server) {
		...
		args.push("-Dio.github.dauntedclient.client.version=" + Utils.version);
		args.push("-Dio.github.dauntedclient.client.launcher=ours");
		args.push("-Dio.github.dauntedclient.client.autoupdate=true");
		args.push("-Dio.github.dauntedclient.wrapper.jar=" + versionJar);

		if(Config.data.optifine) {
			args.push("-Dio.github.dauntedclient.wrapper.optifine=true");
		}
		...
		args.push("-Dio.github.dauntedclient.client.discord_lib=" + discordNativeLibrary);
		...
		classpath += path.join(__dirname, "wrapper/build/libs/daunted-client-wrapper.jar");
		classpath += classpathSeparator;

		args.push(classpath);

		args.push("io.github.dauntedclient.wrapper.Launcher");

		args.push("--version");
		args.push("Daunted Client");
		...
		args.push("io.github.dauntedclient.client.tweak.Tweaker");
